...
if (!function_exists('renderHeader')) {
     ...
     *
     * @param string|null $pageHeading Optional heading displayed beneath the navigation.
     * @param array<int, array<string, mixed>|string> $subNavLinks Links to include in the sub navigation bar.
     */
    function renderHeader(?string $pageHeading = null, array $subNavLinks = []): void
    {
        $mainNavLinks = [
...
<header>
    ...
    <?php if ($pageHeading !== null && $pageHeading !== ''): ?>
        <h2><?= htmlspecialchars($pageHeading, ENT_QUOTES) ?></h2>
    <?php endif; ?>
</header>
<?php
    }
